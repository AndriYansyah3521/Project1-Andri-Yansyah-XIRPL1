...
public class MainAplikasiKasir {
    ...
    public static void main(String[] args){
        ...
        do{
            ...
            //khusus untuk menu ramen, pesanan kuahnya langsung di input juga
                ...
                do{
                    ...
                    do {
                        ...
                        if (jumlah_kuah > jumlah_ramen){
                            System.out.print("[Err] Jumlah kuah melebihi jumlah ramen yang sudah dipesan");
                        }else {
        ...
        //hitung pajak
        //jika makan di tempat, biaya pajak = 10% ppn + 5% service
        ...
        no_transaksi_lagi = input.next();
        }while(no_transaksi_lagi.equalsIgnoreCase("Y"));
